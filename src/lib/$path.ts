export const pagesPath = {
  ...
  Sample: {
    ...
    sample20: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample20' as const };
      },
    },
    sample21: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample21' as const };
      },
    },
    sample22: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample22' as const };
      },
    },
    sample23: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample23' as const };
      },
    },
    sample24: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample24' as const };
      },
    },
    sample25: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample25' as const };
      },
    },
    sample26: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample26' as const };
      },
    },
    sample27: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/Sample/sample27' as const };
      },
    },
    sample3: {
      $url: (url?: { hash?: string }) => {
  ...
  UI: {
    index1: {
      $url: (url?: { hash?: string }) => {
        return { hash: url?.hash, pathname: '/UI/index1' as const };
      },
    },
  },
  YouTube: {
