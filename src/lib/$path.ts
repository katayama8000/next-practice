export const pagesPath = {
  ...
  "sample10": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample10' as const, hash: url?.hash })
  },
  "sample11": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample11' as const, hash: url?.hash })
  },
  "sample12": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample12' as const, hash: url?.hash })
  },
  "sample13": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample13' as const, hash: url?.hash })
  },
  "sample14": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample14' as const, hash: url?.hash })
  },
  "sample15": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample15' as const, hash: url?.hash })
  },
  "sample2": {
  ...
  "sample9": {
    $url: (url?: { hash?: string }) => ({ pathname: '/sample9' as const, hash: url?.hash })
  },
